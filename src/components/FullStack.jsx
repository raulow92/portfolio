...
const FullStack = () => {
    ...
    >   
        ...
        <div className="text-left">
            <p className="max-[400px]:text-sm text-base lg:text-2xl font-semibold whitespace-nowrap">Full Stack JavaScript</p>
            <p className="max-[400px]:text-xs text-sm lg:text-lg">Desafio Latam 2023</p>
        </div>
    </motion.a>
