...
const Skills = () => {
    return (
        <div className="grid grid-cols-4 place-content-center place-items-center justify-center gap-2 md:gap-4 order-8 md:order-10 col-span-2 rounded-[2rem] font-medium bg-[#ececec] dark:bg-neutral-900 text-xl lg:text-4xl text-neutral-600 dark:text-neutral-300 px-6 md:px-8 transition-colors duration-300 ease-in-out relative overflow-hidden z-10">
