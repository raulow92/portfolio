...
const PokeCard = () => {
    return (
        <motion.div
            ...
            className="flex place-items-center group relative rounded-[2rem] bg-[#ececec]  dark:bg-neutral-900 transition-colors duration-300 ease-in-out text-neutral-600 dark:text-neutral-300 order-10 md:order-11 col-span-2 overflow-hidden z-10"
        >
            ...
            <div className="ml-6 md:ml-10 2xl:ml-14 z-50">
                <h2 className="dark:text-shadow text-2xl md:text-4xl 2xl:text-5xl font-medium text-gray-800 dark:text-gray-200 select-none z-50 font-outline">
                    Music App
                </h2>
                ...
                <div className="mt-1 md:mt-2 text-xs md:text-sm 2xl:text-base font-semibold hidden group-hover:flex transition-all ease-in-out duration-300">
                    <a
                        href="https://music-app-uc.vercel.app/"
                        target="_blank"
                    ...
                    <a
                        href="https://github.com/raulow92/music-app"
                        target="_blank"
                        rel="noopener noreferrer"
            ...
            <div className="rounded-2xl w-40 lg:w-72 2xl:w-[350px] overflow-hidden -rotate-12 absolute top-2 2xl:top-6 -right-16 md:-right-24 2xl:-right-32 group-hover:scale-[115%] group-hover:-rotate-6 transition-all duration-300 ease-in-out -z-20 drop-shadow-xl">
                <img src={MusicImg} alt="imagen sipo" />
            </div>
        </motion.div>
    );
};
