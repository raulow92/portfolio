...
import sipoImg from "../assets/images/sipo.png";
...
const SipoCard = () => {
    return (
        <motion.div
            ...
            className="flex place-items-center group relative rounded-[2rem] bg-[#ececec]  dark:bg-neutral-900 transition-colors duration-300 ease-in-out text-neutral-600 dark:text-neutral-300 order-7 col-span-3 overflow-hidden z-10 h-32 md:h-auto"
        >
            ...
            <div className="ml-6 md:ml-10 2xl:ml-14 z-50">
                ...
                <div className="mt-1 md:mt-2 text-xs md:text-sm 2xl:text-base font-semibold hidden group-hover:flex transition-all ease-in-out duration-300">
                    ...
                    <a
                        href="https://github.com/raulow92/Sipo"
                        target="_blank"
                        rel="noopener noreferrer"
            ...
            <div className="rounded-2xl w-60 lg:w-80 2xl:w-[410px] overflow-hidden -rotate-12 absolute top-2 -right-12 group-hover:scale-[115%] group-hover:-rotate-6 transition-all duration-300 ease-in-out -z-20 drop-shadow-xl">
                <img src={sipoImg} alt="imagen sipo" />
            </div>
        </motion.div>
    );
};

export default SipoCard;
