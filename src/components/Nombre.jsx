...
const Nombre = () => {
    ...
    return (
        <motion.div
            ...
            className="flex flex-col order-7 justify-center col-span-3 bg-[#ececec] dark:bg-neutral-900 rounded-[2rem] p-8 md:p-0 text-center transition-colors duration-300 ease-in-out cursor-pointer relative overflow-hidden z-10"
        >
            <div className="absolute w-full h-full left-0 bg-gradient-to-b from-transparent dark:to-black to-neutral-400 dark:opacity-30 opacity-20 -z-10"></div>
            ...
            <h1
                onClick={handleClick}
                className="font-extrabold tracking-tight text-transparent max-[400px]:text-6xl text-7xl lg:text-8xl 2xl:text-9xl bg-clip-text bg-gradient-to-b dark:from-purple-300 dark:to-purple-800 from-purple-800 to-blue-500 whitespace-nowrap select-none overflow-visible"
            >
                Raúl Low
            </h1>
